            ...
            for p in range(len(puzzle[layer])):
                ...
                if (is_possible == True):
                    ...
                    if (direct > 10):
                        ...
                        #
                        # if (direct == 3 or direct == 7):
                        #     vis[j + way[direct][1]][i + int(way[direct][0]/2)] = layer
                        # if (direct == 1 or direct == 5):
                        #     vis[j + int(way[direct][1]/2)][i + way[direct][0]] = layer
                        if (temp == 3 or temp == 7):
                    ...
                    if (direct > 10):
                        ...
                        #
                        # if (direct == 3 or direct == 7):
                        #     vis[j + way[direct][1]][i + int(way[direct][0]/2)] = False
                        # if (direct == 1 or direct == 5):
                        #     vis[j + int(way[direct][1]/2)][i + way[direct][0]] = False
                        if (temp == 3 or temp == 7):
